...
def load_inputs(embeddings_path: str, labels_path: str, label_col: str, max_up: int):
    cwd = Path.cwd()
    emb_path = resolve_input_path(embeddings_path, cwd=cwd, max_up=max_up, base_dir=None)
    labels_path = resolve_input_path(labels_path, cwd=cwd, max_up=max_up, base_dir=None)
...
def main():
    ...
    ap.add_argument("--embeddings", type=str, default="embeddings.npy")
    ap.add_argument("--labels-clean", type=str, default="labels_clean.csv")
